...
/**
 * 
 * This class has been copy-pasted from JBehave examples repository since
 * official downloadable libs didn't contain its package.</br>
 * Original class documentation follows:</br>
